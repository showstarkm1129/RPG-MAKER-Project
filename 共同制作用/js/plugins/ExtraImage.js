 ...
 * @param SceneName
 * @text 目标场景
 * @desc 要显示额外图像的场景。若要指定自定义场景，请直接输入场景类名。
 * @type select
 * @default Scene_Title
 * @option 标题画面
 * @value Scene_Title
 ...
 * @param FileName
 * @text 文件名
 * @desc 要显示的图像文件。请从 pictures 文件夹中选择。不需要扩展名。
 * @default
 * @require 1
 * @dir img/pictures
 * @type file
 ...
 * @param Priority
 * @text 显示优先级
 * @desc 图像的显示层级。“最背面”通常不会显示在画面上，不建议在一般情况下使用。
 * @default 0
 * @type select
 * @option 最前面
 * @value 0
 ...
 * @param Switch
 * @text 显示条件开关
 * @desc 仅当指定的开关为 ON 时显示图像。若未指定，则始终显示。
 * @default 0
 * @type switch
 */
